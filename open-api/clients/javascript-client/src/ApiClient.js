...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HavfenCommunityApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default http://api.hafven-community.ngrok.io/v2
     */
    this.basePath = 'http://api.hafven-community.ngrok.io/v2'.replace(/\/+$/, '');
