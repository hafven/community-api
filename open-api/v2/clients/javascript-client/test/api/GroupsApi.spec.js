...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HafvenCommunityApi.GroupsApi();
  });
  ...
  describe('GroupsApi', function() {
    ...
    describe('findGroupsByStatus', function() {
      it('should call findGroupsByStatus successfully', function(done) {
        //uncomment below and update the code to test findGroupsByStatus
        //instance.findGroupsByStatus(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('findGroupsByTags', function() {
      it('should call findGroupsByTags successfully', function(done) {
        //uncomment below and update the code to test findGroupsByTags
        //instance.findGroupsByTags(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateGroupWithForm', function() {
      it('should call updateGroupWithForm successfully', function(done) {
        //uncomment below and update the code to test updateGroupWithForm
        //instance.updateGroupWithForm(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
